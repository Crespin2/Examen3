package com.jamc.crud_sqlite_2tablas;
...
public class ConexionSQLite extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into tb_categorias values('1', 'Monitor', '1', '22/09/2022)')");
        db.execSQL("insert into tb_categorias values('2', 'Celular', '1', '22/09/2022)')");
        db.execSQL("insert into tb_categorias values('3', 'TV', '1', '23/09/2022)')");
        db.execSQL("insert into tb_categorias values('4', 'Laptop', '1', '23/09/2022)')");
        db.execSQL("insert into tb_categorias values('5', 'Computadora', '1', '24/09/2022)')");
    }
